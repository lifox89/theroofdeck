...
<head>
    ...
    <!-- Javascript -->
    <script type="text/javascript" src=<?php echo base_url();?>assets/dist/js/app.js></script>
    <script type="text/javascript" src=<?php echo base_url();?>assets/dist/js/index.js></script>
    <!-- <script type="text/javascript" src=<?php echo base_url();?>assets/js/coffee/custom.js></script> -->
                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <ol class="breadcrumb navbar-breadcrumb">
                            <li class="active">Restaurant Dashboard</li>
                        </ol>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown profile">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Clifford Diaz <span class="caret"></span></a>
                            <ul class="dropdown-menu animated fadeInDown">
                                <li class="profile-img">
                                   <!--  <img src="../img/profile/picjumbo.com_HNCK4153_resize.jpg" class="profile-img"> -->
                                   <img src=<?php echo base_url();?>assets/img/profile/clifford.jpg class="profile-img">
                                </li>
                                <li>
                                    <div class="profile-info">
                                        <h4 class="username">Clifford Diaz</h4>
                                        <p>lifox89@gmail.com</p>
